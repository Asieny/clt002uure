...
public abstract class AbsActivity extends FragmentActivity
{
     ...
     * 参见{@link Activity#onActivityResult(int, int, Intent) onActivityResult(int, int, Intent)} 和
    ...
    {
        setResult(resultCode, data == null ? new Intent().putExtra(Const.EXTRA_BACK_CONTINUOUS, true) : data.putExtra(Const.EXTRA_BACK_CONTINUOUS, true));
        finish();
    }
    ...
    {
        setResult(resultCode, data == null ? new Intent().putExtra(Const.EXTRA_BACK_TO_NAME, actyClassName) : data.putExtra(Const.EXTRA_BACK_TO_NAME, actyClassName));
        finish();
    }
    ...
    {
        setResult(resultCode, data == null ? new Intent().putExtra(Const.EXTRA_BACK_TO_COUNT, count) : data.putExtra(Const.EXTRA_BACK_TO_COUNT, count));
        finish();
    }
