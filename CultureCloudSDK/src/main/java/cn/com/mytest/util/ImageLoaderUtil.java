...
public class ImageLoaderUtil
{
    ...
    // 默认头像
    static DisplayImageOptions defalutOptionsIcon = new DisplayImageOptions.Builder().showImageOnLoading(R.mipmap.ic_launcher)
    ...
    // 渐变显示图片
    static DisplayImageOptions fadeOptions = new DisplayImageOptions.Builder().showImageOnLoading(R.mipmap.ic_launcher)
        .showImageForEmptyUri(R.mipmap.ic_launcher)
        .showImageOnFail(R.mipmap.ic_launcher)
        .cacheInMemory(true)
        .cacheOnDisk(true)
    ...
    public static DisplayImageOptions getRound(ImageView img)
    {
        ...
        DisplayImageOptions roundOptionsIcon =
            new DisplayImageOptions.Builder().showImageOnLoading(R.mipmap.ic_launcher)
                .showImageForEmptyUri(R.mipmap.ic_launcher)
                .showImageOnFail(R.mipmap.ic_launcher)
                .cacheInMemory(true)
                .cacheOnDisk(true)
