...
import com.guangxi.culturecloud.adapter.GuideViewPagerAdapter;
 ...
 * 
 */
public class WelcomeGuideActivity extends BaseActivity implements OnClickListener,View.OnTouchListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		for (int i = 0; i < pics.length; i++) {
			...
			if (i == pics.length - 1) {
				imageViewStart = (ImageView) view.findViewById(R.id.img_start);
				imageViewStart.setTag("enter");
				imageViewStart.setOnTouchListener(this);
